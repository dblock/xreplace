...
procedure VarClear(var V);
procedure VarCopy(var Dest; const Source: Variant);
procedure VarCast(var Dest; const Source: Variant; VarType: Integer);
...
procedure VarArrayRedim(var A; HighBound: Integer);
...
begin
  ...
  asm
    db 'Portions Copyright (c) 1983,96 Borland',0
  end;
